class CronSchedule < ApplicationRecord
  TASK_TYPES = %w[categories products bestsellers popular_categories category_images product_images extended_attributes currency_rates pl_prices_stock seo_catalog_pages cancel_expired_unpaid_orders send_abandoned_cart_emails].freeze
