class ParserTask < ApplicationRecord
  TASK_TYPES = %w[recover_broken_product_images update_all_product_images update_product_variants optimize_home_banner_images categories products bestsellers popular_categories category_images product_images extended_attributes currency_rates category_filters category_filters_one category_filters_tree refresh_category_catalog refresh_category_filters_lt merge_parent_category_filters rebuild_category_fseries_filters extended_attrs_import fix_missing_images extended_attributes_by_skus import_products_by_skus recover_missing_images recover_missing_weights recover_missing_packaging_dimensions refresh_category_lt refresh_product_lt harvest_category_related_products pl_prices_stock count_broken_packaging_dimensions count_broken_product_images count_broken_product_translations recover_broken_product_translations collect_product_video_stats collect_product_document_stats].freeze
