...
namespace :sidekiq do
  ...
  # QUEUE=ikea_api_production_parser — очистить всю очередь.
  # QUEUE=ikea_api_production_parser CLASS_SUBSTRING=ReindexProductFiltersJob — только совпадающие классы.
