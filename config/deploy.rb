...
append :linked_dirs, "log", "tmp/pids", "tmp/cache", "tmp/sockets", "tmp/trestle_exports", "tmp/product_video_stats", "tmp/product_document_stats", 'public/system', 'storage', 'public/images', 'public/documents'
