...
Rails.application.configure do
  ...
  config.active_record.encryption.primary_key = "test_primary_key_must_be_32_chars_long_123"
  config.active_record.encryption.deterministic_key = "test_deterministic_key_must_be_32_chars_long"
