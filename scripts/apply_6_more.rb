...
NEW_MAPPING = {
  'Тюль' => '700220',
  'Столешницы для офисных столов' => '11844',
  'Светодиодная подсветка с датчиком движения' => '20516',
  'Раскладные и раздвижные столы' => '21829',
  'Пуховые подушки' => '20535',
  'Портативная бытовая техника' => '700175'
}
